export default function Politica() {
  return (
    <div>
      ...
      <p>
        A sua privacidade é importante para nós. É política do Inova respeitar a
        sua privacidade em relação a qualquer informação sua que possamos
        coletar no site <a href="inova.uaiinovei.com.br">Inova </a>, e outros
      ...
      <h2>Política de Cookies Inova </h2> <h3>O que são cookies?</h3>
      <p>
      ...
      <p>
        ...
        informação que o Inova oferece no site e com caráter enunciativo, mas
        não limitativo:
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          xenofóbica, ou casas de apostas legais (ex.: Betano), jogos de sorte e
      ...
      <p>
        Esta política é efetiva a partir de <strong>August</strong>/
        <strong>2021</strong>.
      </p>
    </div>
  );
